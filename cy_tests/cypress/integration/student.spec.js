describe("Student`s section test", () => {
    ...
    it("Update student with Id 1080024 name", () => {
      cy.visit("http://localhost:3000/students/1080024");
      cy.get("#name").type("OtherTestName");
      cy.get(".update-entity-form > .button").click();
      cy.wait(3000);
      cy.get(".left-side > :nth-child(4)").should("have.text", "OtherTestName");
      cy.get("#name").clear().type("testNoBorrar");
      cy.get(".update-entity-form > .button").click();
    })
  })